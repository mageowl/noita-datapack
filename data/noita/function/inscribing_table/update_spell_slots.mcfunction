...
execute if score @s noita.inscribing_table.spell_slots matches 1..9 run item replace block ~ ~ ~ container.0 with black_stained_glass_pane[,max_stack_size=1,hide_tooltip={},custom_data={custom_id:"noita:gui",noita:{is_gui: true}}]
