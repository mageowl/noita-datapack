...
data modify entity @e[tag=noita.new, limit=1] data.spells set from entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".noita.spells
...
item modify entity @s[gamemode=survival] weapon.mainhand noita:decrease